...
%% -*- erlang -*-
%%
%% Encode a CENTURY-ENCODING INTEGER (0..99) using APER or UPER from
%% Erlang/OTP compiled modules.
%%
%% Usage:
%%   escript encode_century_encoding.erl -value <int> [-aligned]
%%
...
main(Args) ->
    ...
    case 'CENTURY':encode('CENTURY-ENCODING', Value) of
        {ok, Enc} ->
...
usage(Msg) ->
    io:format(standard_error,
        "error: ~s~nUsage: escript encode_century_encoding.erl -value <int> [-aligned]~n",
        [Msg]),
    halt(1).
