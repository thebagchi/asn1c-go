...
%% -*- erlang -*-
%%
%% Encode a DURATION-INTERVAL-ENCODING SEQUENCE using APER or UPER from
%% Erlang/OTP compiled modules. Every field is optional; omit a flag to
%% leave the corresponding component absent (asn1_NOVALUE).
%%
%% Usage:
%%   escript encode_duration_interval_encoding.erl [-years <int>] [-months <int>] [-weeks <int>] [-days <int>] [-hours <int>] [-minutes <int>] [-seconds <int>] [-number-of-digits <int>] [-fractional-value <int>] [-aligned]
%%
...
usage(Msg) ->
    io:format(standard_error,
        "error: ~s~nUsage: escript encode_duration_interval_encoding.erl [-years <int>] [-months <int>] [-weeks <int>] [-days <int>] [-hours <int>] [-minutes <int>] [-seconds <int>] [-number-of-digits <int>] [-fractional-value <int>] [-aligned]~n",
        [Msg]),
    halt(1).
