...
// MinutesUtcAndFractionEncoding is the X.691 (02/2021) clause 32.3
// MINUTES-UTC-AND-FRACTION-ENCODING type, used to PER-encode a TIME-family
...
// accuracy.
type MinutesUtcAndFractionEncoding struct {
	Hours    int64 `per:"lb=0,ub=24"`
	Minutes  int64 `per:"lb=0,ub=59"`
	Fraction int64 `per:"lb=0,ub=999,ext"`
}

// MarshalPER encodes the MinutesUtcAndFractionEncoding using Packed
...
// this.
func (m *MinutesUtcAndFractionEncoding) MarshalPER(encoder *per.Encoder) ([]byte, error) {
...
// MarshalAPER encodes the MinutesUtcAndFractionEncoding using Aligned Packed Encoding Rules (APER).
func (m *MinutesUtcAndFractionEncoding) MarshalAPER() ([]byte, error) {
	encoder := per.NewEncoder(true)
	return m.MarshalPER(encoder)
}

// MarshalUPER encodes the MinutesUtcAndFractionEncoding using Unaligned Packed Encoding Rules (UPER).
func (m *MinutesUtcAndFractionEncoding) MarshalUPER() ([]byte, error) {
	encoder := per.NewEncoder(false)
	return m.MarshalPER(encoder)
}

// UnmarshalPER decodes the MinutesUtcAndFractionEncoding using Packed
...
// this.
func (m *MinutesUtcAndFractionEncoding) UnmarshalPER(decoder *per.Decoder) error {
	// hours INTEGER (0..24) — constrained lb=0, ub=24
	{
		lb, ub := int64(0), int64(24)
...
// UnmarshalAPER decodes the MinutesUtcAndFractionEncoding using Aligned Packed Encoding Rules (APER).
func (m *MinutesUtcAndFractionEncoding) UnmarshalAPER(data []byte) error {
	decoder := per.NewDecoder(data, true)
	return m.UnmarshalPER(decoder)
}

// UnmarshalUPER decodes the MinutesUtcAndFractionEncoding using Unaligned Packed Encoding Rules (UPER).
func (m *MinutesUtcAndFractionEncoding) UnmarshalUPER(data []byte) error {
