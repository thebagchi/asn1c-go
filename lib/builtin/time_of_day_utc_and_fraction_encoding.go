...
// TimeOfDayUtcAndFractionEncoding is the X.691 (02/2021) clause 32.3
// TIME-OF-DAY-UTC-AND-FRACTION-ENCODING type, used to PER-encode a
// TIME-family value whose abstract values have the "Basic=Time
// Time=HMSF3 Local-or-UTC=Z" property setting.
//
...
type TimeOfDayUtcAndFractionEncoding struct {
...
// MarshalPER encodes the TimeOfDayUtcAndFractionEncoding using Packed
...
// this.
func (t *TimeOfDayUtcAndFractionEncoding) MarshalPER(encoder *per.Encoder) ([]byte, error) {
...
// MarshalAPER encodes the TimeOfDayUtcAndFractionEncoding using Aligned Packed Encoding Rules (APER).
func (t *TimeOfDayUtcAndFractionEncoding) MarshalAPER() ([]byte, error) {
	encoder := per.NewEncoder(true)
	return t.MarshalPER(encoder)
}

// MarshalUPER encodes the TimeOfDayUtcAndFractionEncoding using Unaligned Packed Encoding Rules (UPER).
func (t *TimeOfDayUtcAndFractionEncoding) MarshalUPER() ([]byte, error) {
	encoder := per.NewEncoder(false)
	return t.MarshalPER(encoder)
}

// UnmarshalPER decodes the TimeOfDayUtcAndFractionEncoding using Packed
...
// this.
func (t *TimeOfDayUtcAndFractionEncoding) UnmarshalPER(decoder *per.Decoder) error {
	// hours INTEGER (0..24) — constrained lb=0, ub=24
	{
		lb, ub := int64(0), int64(24)
...
// UnmarshalAPER decodes the TimeOfDayUtcAndFractionEncoding using Aligned Packed Encoding Rules (APER).
func (t *TimeOfDayUtcAndFractionEncoding) UnmarshalAPER(data []byte) error {
	decoder := per.NewDecoder(data, true)
	return t.UnmarshalPER(decoder)
}

// UnmarshalUPER decodes the TimeOfDayUtcAndFractionEncoding using Unaligned Packed Encoding Rules (UPER).
func (t *TimeOfDayUtcAndFractionEncoding) UnmarshalUPER(data []byte) error {
