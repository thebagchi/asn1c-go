...
def main():
    ...
    cases = [
        ...
        make_bit_string(255, None, None, False),
        make_bit_string(255, 0, None, False),
        make_bit_string(255, 0, 512, False),
        ...
        make_bit_string(255, 0, 128, True),
        ...
        make_bit_string(0, 0, 8, True),
        make_bit_string(4, 0, 8, True),
        make_bit_string(8, 0, 8, True),
        make_bit_string(0, 0, 16, True),
        make_bit_string(8, 0, 16, True),
        make_bit_string(16, 0, 16, True),
        make_bit_string(16, 0, 32, True),
        make_bit_string(32, 0, 32, True),
        make_bit_string(32, 0, 64, True),
        make_bit_string(64, 0, 64, True),
        make_bit_string(64, 0, 128, True),
        make_bit_string(128, 0, 128, True),
        make_bit_string(128, 0, 256, True),
        make_bit_string(256, 0, 256, True),
        make_bit_string(256, 0, 512, True),
        make_bit_string(512, 0, 512, True),
        make_bit_string(512, 0, 1024, True),
        make_bit_string(1024, 0, 1024, True),
        # ---- Empty bit string (length=0) ----
        make_bit_string(0, None, None, False),
        make_bit_string(0, 0, None, False),
        make_bit_string(0, 0, 8, False),
        make_bit_string(0, 0, 128, False),
        make_bit_string(0, 0, 65536, False),
        # ---- lb > 0 constrained ranges ----
        make_bit_string(4, 4, 16, False),
        make_bit_string(8, 4, 16, False),
        make_bit_string(16, 4, 16, False),
        make_bit_string(8, 8, 32, False),
        make_bit_string(16, 8, 32, False),
        make_bit_string(32, 8, 32, False),
        make_bit_string(16, 16, 64, False),
        make_bit_string(32, 16, 64, False),
        make_bit_string(64, 16, 64, False),
        # ---- lb > 0 constrained, extensible ----
        make_bit_string(4, 4, 16, True),
        make_bit_string(16, 4, 16, True),
        make_bit_string(32, 4, 16, True),
        make_bit_string(8, 8, 32, True),
        make_bit_string(32, 8, 32, True),
        make_bit_string(64, 8, 32, True),
    ]
    for case in cases:
        length = case["length"]
        lb = case["lb"]
    ...
    erlang_cases = [
        ...
        make_bit_string(4, 4, 16, False),
        make_bit_string(10, 4, 16, False),
        make_bit_string(16, 4, 16, False),
        make_bit_string(8, 8, 32, False),
        make_bit_string(20, 8, 32, False),
        make_bit_string(32, 8, 32, False),
        make_bit_string(16, 16, 64, False),
        make_bit_string(40, 16, 64, False),
        make_bit_string(64, 16, 64, False),
        ...
        make_bit_string(8, 8, 32, True),
        make_bit_string(32, 8, 32, True),
        make_bit_string(16, 16, 64, True),
        make_bit_string(64, 16, 64, True),
        # lb > 0 constrained, extensible (outside root)
        make_bit_string(3, 4, 16, True),
        make_bit_string(17, 4, 16, True),
        make_bit_string(7, 8, 32, True),
        make_bit_string(33, 8, 32, True),
        make_bit_string(15, 16, 64, True),
        make_bit_string(65, 16, 64, True),
    ]
